...
[![Demo](https://img.shields.io/badge/Demo-Live-brightgreen)](https://adsense-tau.vercel.app/)
...
**🔗 [https://adsense-tau.vercel.app/](https://adsense-tau.vercel.app/)**
...
```bash
git clone https://github.com/shuxue6662-a11y/adsense-demo.git
cd adsense-demo
```
...
详细产品方案请查看：[docs/说明文档.pdf](docs/说明文档.pdf)
...
- [Vercel](https://vercel.com) - 静态网站托管
